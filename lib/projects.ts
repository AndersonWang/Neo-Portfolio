...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Bridging the Ballyverse — a hardware/software system for 19 casino properties, designed for players, staff, and executive buy-in.",
    year:        2022,
    tags:        [
      { label: "Hardware UX",   color: "gold"    },
      { label: "System Design", color: "neutral" },
    ],
    featured:    true,
  },
  {
